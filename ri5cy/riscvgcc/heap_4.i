# 1 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/MemMang/heap_4.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/MemMang/heap_4.c" 2
# 78 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/MemMang/heap_4.c"
...
# 79 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/MemMang/heap_4.c" 2
...
# 86 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/MemMang/heap_4.c" 2
...
# 87 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/MemMang/heap_4.c" 2
# 106 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/MemMang/heap_4.c"
...
# 125 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/MemMang/heap_4.c"
...
static BlockLink_t xStart, *pxEnd = ((void*)0);
...
void *pvReturn = ((void*)0);
 ...
 vTaskSuspendAll();
 {
  ...
  if( ( xWantedSize & xBlockAllocatedBit ) == 0 )
  {
   ...
   if( xWantedSize > 0 )
   {
    ...
    if( ( xWantedSize & ( 0x0000 ) ) != 0x00 )
    {

     xWantedSize += ( 1 - ( xWantedSize & ( 0x0000 ) ) );
     if(( ( xWantedSize & ( 0x0000 ) ) == 0) == 0) {vPortSetInterruptMask(); for (;;);};
    }
    else
    {
                             ;
   ...
   if( ( xWantedSize > 0 ) && ( xWantedSize <= xFreeBytesRemaining ) )
   {
    ...
    if( pxBlock != pxEnd )
    {
     ...
     if( ( pxBlock->xBlockSize - xWantedSize ) > ( ( size_t ) ( xHeapStructSize << 1 ) ) )
     {
      ...
      if(( ( ( ( size_t ) pxNewBlockLink ) & ( 0x0000 ) ) == 0) == 0) {vPortSetInterruptMask(); for (;;);};
 ...
 ( void ) xTaskResumeAll();
# 300 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/MemMang/heap_4.c"
 if(( ( ( ( size_t ) pvReturn ) & ( size_t ) ( 0x0000 ) ) == 0) == 0) {vPortSetInterruptMask(); for (;;);};
 return pvReturn;
}
...
BlockLink_t *pxLink;
 ...
 if( pv != ((void*)0) )
 {
  ...
  if(( ( pxLink->xBlockSize & xBlockAllocatedBit ) != 0) == 0) {vPortSetInterruptMask(); for (;;);};
  if(( pxLink->pxNextFreeBlock == ((void*)0)) == 0) {vPortSetInterruptMask(); for (;;);};
...
size_t uxAddress;
size_t xTotalHeapSize = ((size_t)(10 * 1024));
