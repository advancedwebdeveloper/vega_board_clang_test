# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c" 2
# 10 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c"
...
# 11 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c" 2
# 59 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c"
uint32_t g_xtal0Freq;

uint32_t g_xtal32Freq;
# 71 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c"
uint32_t CLOCK_GetOsc32kClkFreq(void)
{
    ((g_xtal32Freq) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c", 73, __func__, "g_xtal32Freq"));
    return g_xtal32Freq;
}
...
uint32_t CLOCK_GetIpFreq(clock_ip_name_t name)
{
    ...
    ((reg & (0x80000000U)) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c", 201, __func__, "reg & PCC_CLKCFG_PR_MASK"));
    ...
    if (0U != (reg & ((0x7U) | (0x8U))))
    {
        return freq * (((reg & (0x8U)) >> (3U)) + 1U) / (((reg & (0x7U)) >> (0U)) + 1U);
    }
    else
    {
        return freq;
...
_Bool CLOCK_EnableUsbfs0Clock(clock_usb_src_t src, uint32_t freq)
{
    ...
    ((USBVREG_Type *)(0x40027000u))->CTRL |= (0x80000000U);
    ((USB_Type *)(0x40045000u))->CONTROL &= ~(0x10U);

    if (kCLOCK_UsbSrcIrc48M == src)
    {
        ((USB_Type *)(0x40045000u))->CLK_RECOVER_IRC_EN = 0x03U;
        ((USB_Type *)(0x40045000u))->CLK_RECOVER_CTRL |= (0x80U);
        ((USB_Type *)(0x40045000u))->CLK_RECOVER_INT_EN = 0x00U;
    }
    return ret;
}
...
status_t CLOCK_InitSysOsc(const scg_sosc_config_t *config)
{
    ((config) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c", 323, __func__, "config"));
    status_t status;
    uint8_t tmp8;
    ...
    ((SCG_Type *)(0x4002C000u))->SOSCDIV =
        (((uint32_t)(((uint32_t)(config->div1)) << (0U))) & (0x7U)) | (((uint32_t)(((uint32_t)(config->div2)) << (8U))) & (0x700U)) | (((uint32_t)(((uint32_t)(config->div3)) << (16U))) & (0x70000U));
    ...
    tmp8 |= (0x1U);
    ((SCG_Type *)(0x4002C000u))->SOSCCSR = tmp8;


    while (!(((SCG_Type *)(0x4002C000u))->SOSCCSR & (0x1000000U)))
    {
    }


    ((SCG_Type *)(0x4002C000u))->SOSCCSR |= (uint32_t)config->monitorMode;
...
uint32_t CLOCK_GetSysOscFreq(void)
{
    if (((SCG_Type *)(0x4002C000u))->SOSCCSR & (0x1000000U))
    {

        ((g_xtal0Freq) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c", 385, __func__, "g_xtal0Freq"));
        return g_xtal0Freq;
    }
    else
    {
...
uint32_t CLOCK_GetSysOscAsyncFreq(scg_async_clk_t type)
{
    ...
    if (oscFreq)
    {
        ...
        {
            case kSCG_AsyncDiv3Clk:
                divider = ((((SCG_Type *)(0x4002C000u))->SOSCDIV & (0x70000U)) >> (16U));
                break;
            case kSCG_AsyncDiv2Clk:
                divider = ((((SCG_Type *)(0x4002C000u))->SOSCDIV & (0x700U)) >> (8U));
                break;
            case kSCG_AsyncDiv1Clk:
                divider = ((((SCG_Type *)(0x4002C000u))->SOSCDIV & (0x7U)) >> (0U));
                break;
            default:
                break;
        }
...
status_t CLOCK_InitSirc(const scg_sirc_config_t *config)
{
    ((config) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c", 429, __func__, "config"));
    ...
    ((SCG_Type *)(0x4002C000u))->SIRCDIV =
        (((uint32_t)(((uint32_t)(config->div1)) << (0U))) & (0x7U)) | (((uint32_t)(((uint32_t)(config->div2)) << (8U))) & (0x700U)) | (((uint32_t)(((uint32_t)(config->div3)) << (16U))) & (0x70000U));


    ((SCG_Type *)(0x4002C000u))->SIRCCFG = (((uint32_t)(((uint32_t)(config->range)) << (0U))) & (0x1U));


    ((SCG_Type *)(0x4002C000u))->SIRCCSR = (0x1U) | config->enableMode;


    while (!(((SCG_Type *)(0x4002C000u))->SIRCCSR & (0x1000000U)))
    {
    }
...
status_t CLOCK_DeinitSirc(void)
{
    uint32_t reg = ((SCG_Type *)(0x4002C000u))->SIRCCSR;
    ...
    ((SCG_Type *)(0x4002C000u))->SIRCCSR = 0U;
...
uint32_t CLOCK_GetSircFreq(void)
{
    static const uint32_t sircFreq[] = {2000000U, 8000000U};

    if (((SCG_Type *)(0x4002C000u))->SIRCCSR & (0x1000000U))
    {
        return sircFreq[((((SCG_Type *)(0x4002C000u))->SIRCCFG & (0x1U)) >> (0U))];
    }
    else
    {
        return 0U;
...
uint32_t CLOCK_GetSircAsyncFreq(scg_async_clk_t type)
{
    ...
    if (sircFreq)
    {
        ...
        {
            case kSCG_AsyncDiv3Clk:
                divider = ((((SCG_Type *)(0x4002C000u))->SIRCDIV & (0x70000U)) >> (16U));
                break;
            case kSCG_AsyncDiv2Clk:
                divider = ((((SCG_Type *)(0x4002C000u))->SIRCDIV & (0x700U)) >> (8U));
                break;
            case kSCG_AsyncDiv1Clk:
                divider = ((((SCG_Type *)(0x4002C000u))->SIRCDIV & (0x7U)) >> (0U));
                break;
            default:
                break;
        }
...
status_t CLOCK_InitFirc(const scg_firc_config_t *config)
{
    ((config) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c", 530, __func__, "config"));
    ...
    ((SCG_Type *)(0x4002C000u))->FIRCDIV =
        (((uint32_t)(((uint32_t)(config->div1)) << (0U))) & (0x7U)) | (((uint32_t)(((uint32_t)(config->div2)) << (8U))) & (0x700U)) | (((uint32_t)(((uint32_t)(config->div3)) << (16U))) & (0x70000U));


    ((SCG_Type *)(0x4002C000u))->FIRCCFG = (((uint32_t)(((uint32_t)(config->range)) << (0U))) & (0x3U));


    if (config->trimConfig)
    {
        ((SCG_Type *)(0x4002C000u))->FIRCTCFG =
            (((uint32_t)(((uint32_t)(config->trimConfig->trimDiv)) << (8U))) & (0x700U)) | (((uint32_t)(((uint32_t)(config->trimConfig->trimSrc)) << (0U))) & (0x3U));


        if (kSCG_FircTrimNonUpdate == config->trimConfig->trimMode)
        {
            ((SCG_Type *)(0x4002C000u))->FIRCSTAT = (((uint32_t)(((uint32_t)(config->trimConfig->trimCoar)) << (8U))) & (0x3F00U)) |
                            (((uint32_t)(((uint32_t)(config->trimConfig->trimFine)) << (0U))) & (0x7FU));
        }


        ((SCG_Type *)(0x4002C000u))->FIRCCSR = config->trimConfig->trimMode;

        if (((SCG_Type *)(0x4002C000u))->FIRCCSR & (0x4000000U))
        {
            return kStatus_Fail;
        }
    }
    ...
    ((SCG_Type *)(0x4002C000u))->FIRCCSR |= ((0x1U) | (0x100U) | config->enableMode);


    while (!(((SCG_Type *)(0x4002C000u))->FIRCCSR & (0x1000000U)))
    {
    }
...
status_t CLOCK_DeinitFirc(void)
{
    uint32_t reg = ((SCG_Type *)(0x4002C000u))->FIRCCSR;
...
uint32_t CLOCK_GetFircFreq(void)
{
    ...
    if (((SCG_Type *)(0x4002C000u))->FIRCCSR & (0x1000000U))
    {
        return fircFreq[((((SCG_Type *)(0x4002C000u))->FIRCCFG & (0x3U)) >> (0U))];
    }
    else
    {
        return 0U;
...
uint32_t CLOCK_GetFircAsyncFreq(scg_async_clk_t type)
{
    ...
    if (fircFreq)
    {
        ...
        {
            case kSCG_AsyncDiv3Clk:
                divider = ((((SCG_Type *)(0x4002C000u))->FIRCDIV & (0x70000U)) >> (16U));
                break;
            case kSCG_AsyncDiv2Clk:
                divider = ((((SCG_Type *)(0x4002C000u))->FIRCDIV & (0x700U)) >> (8U));
                break;
            case kSCG_AsyncDiv1Clk:
                divider = ((((SCG_Type *)(0x4002C000u))->FIRCDIV & (0x7U)) >> (0U));
                break;
            default:
                break;
        }
...
uint32_t CLOCK_GetRtcOscFreq(void)
{
    if (((SCG_Type *)(0x4002C000u))->ROSCCSR & (0x1000000U))
    {

        ((g_xtal32Freq) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c", 658, __func__, "g_xtal32Freq"));
        return g_xtal32Freq;
    }
    else
    {
...
status_t CLOCK_InitLpFll(const scg_lpfll_config_t *config)
{
    ((config) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_clock.c", 669, __func__, "config"));
    ...
    ((SCG_Type *)(0x4002C000u))->LPFLLDIV = (((uint32_t)(((uint32_t)(config->div1)) << (0U))) & (0x7U)) | (((uint32_t)(((uint32_t)(config->div2)) << (8U))) & (0x700U)) |
                    (((uint32_t)(((uint32_t)(config->div3)) << (16U))) & (0x70000U));


    ((SCG_Type *)(0x4002C000u))->LPFLLCFG = (((uint32_t)(((uint32_t)(config->range)) << (0U))) & (0x3U));


    if (config->trimConfig)
    {
        ((SCG_Type *)(0x4002C000u))->LPFLLTCFG = (((uint32_t)(((uint32_t)(config->trimConfig->trimDiv)) << (8U))) & (0x1F00U)) |
                         (((uint32_t)(((uint32_t)(config->trimConfig->trimSrc)) << (0U))) & (0x3U)) |
                         (((uint32_t)(((uint32_t)(config->trimConfig->lockMode)) << (16U))) & (0x10000U));

        if (kSCG_LpFllTrimNonUpdate == config->trimConfig->trimMode)
        {
            ((SCG_Type *)(0x4002C000u))->LPFLLSTAT = config->trimConfig->trimValue;
        }


        ((SCG_Type *)(0x4002C000u))->LPFLLCSR = config->trimConfig->trimMode;

        if (((SCG_Type *)(0x4002C000u))->LPFLLCSR & (0x4000000U))
        {
            return kStatus_Fail;
        }
    }
    ...
    ((SCG_Type *)(0x4002C000u))->LPFLLCSR |= ((0x1U) | config->enableMode);


    while (!(((SCG_Type *)(0x4002C000u))->LPFLLCSR & (0x1000000U)))
    {
    }
    ...
    {
        while (!(((SCG_Type *)(0x4002C000u))->LPFLLCSR & (0x400U)))
        {
        }
    }
...
status_t CLOCK_DeinitLpFll(void)
{
    uint32_t reg = ((SCG_Type *)(0x4002C000u))->LPFLLCSR;
    ...
    ((SCG_Type *)(0x4002C000u))->LPFLLCSR = (0x4000000U);
...
uint32_t CLOCK_GetLpFllFreq(void)
{
    static const uint32_t lpfllFreq[] = {
        48000000U, 72000000U, 96000000U, 120000000U,
    };

    if (((SCG_Type *)(0x4002C000u))->LPFLLCSR & (0x1000000U))
    {
        return lpfllFreq[((((SCG_Type *)(0x4002C000u))->LPFLLCFG & (0x3U)) >> (0U))];
    }
    else
    {
        return 0U;
...
uint32_t CLOCK_GetLpFllAsyncFreq(scg_async_clk_t type)
{
    ...
    if (lpfllFreq)
    {
        ...
        {
            case kSCG_AsyncDiv2Clk:
                divider = ((((SCG_Type *)(0x4002C000u))->LPFLLDIV & (0x700U)) >> (8U));
                break;
            case kSCG_AsyncDiv1Clk:
                divider = ((((SCG_Type *)(0x4002C000u))->LPFLLDIV & (0x7U)) >> (0U));
                break;
            default:
                break;
        }
