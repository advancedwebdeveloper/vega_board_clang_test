# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c" 2
...
# 13 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/utilities/fsl_io.h"
...
# 14 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/utilities/fsl_io.h" 2
...
# 10 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c" 2
...
# 11 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c" 2
# 56 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
...
# 57 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c" 2
# 89 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
...
# 212 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
void IO_Init(io_state_t *io, uint32_t baudRate, uint32_t clkSrcFreq, uint8_t *ringBuffer)
{
    ((((void*)0) != io) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c", 214, __func__, "NULL != io"));
    ...
    {
# 246 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
        case 2U:
        {
            ...
            LPUART_EnableTx(s_debugConsoleIO.ioBase, 1);
            LPUART_EnableRx(s_debugConsoleIO.ioBase, 1);
# 263 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
        }
        break;
# 334 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
    }
}

status_t IO_Deinit(void)
{
    if (s_debugConsoleIO.ioType == 0U)
    {
        return kStatus_Success;
    }
    ...
    switch (s_debugConsoleIO.ioType)
    {
# 370 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
        case 2U:
            ...
            break;
# 398 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
        default:
            s_debugConsoleIO.ioType = 0U;
            break;
    }
...
status_t IO_WaitIdle(void)
{
    switch (s_debugConsoleIO.ioType)
    {
# 437 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
        case 2U:

            while (!(LPUART_GetStatusFlags(s_debugConsoleIO.ioBase) & kLPUART_TransmissionCompleteFlag))
                ;
            break;
# 452 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
        default:
            break;
    }
...
# 568 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
status_t IO_Transfer(uint8_t *ch, size_t size, _Bool tx)
{
    status_t status = kStatus_Success;
    switch (s_debugConsoleIO.ioType)
    {
# 604 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
        case 2U:
        {
            if (tx)
            {
        ...
        break;
# 648 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_io.c"
        default:
            status = kStatus_Fail;
            break;
    }
