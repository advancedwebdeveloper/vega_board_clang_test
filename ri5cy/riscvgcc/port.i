# 1 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/GCC/RISCY/port.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/GCC/RISCY/port.c" 2
# 71 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/GCC/RISCY/port.c"
...
# 72 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/GCC/RISCY/port.c" 2
...
# 73 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/GCC/RISCY/port.c" 2
...
# 74 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/GCC/RISCY/port.c" 2
...
volatile UBaseType_t uxYieldRequired = ( ( BaseType_t ) 0 );
...
# 109 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/GCC/RISCY/port.c"
...
static void prvTaskExitError( void )
{
    ...
    if(( uxCriticalNesting == ~0UL) == 0) {vPortSetInterruptMask(); for (;;);};
    portCPU_IRQ_DISABLE();
    for(;;);
}
# 162 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/portable/GCC/RISCY/port.c"
...
StackType_t *pxPortInitialiseStack( StackType_t *pxTopOfStack, TaskFunction_t pxCode, void *pvParameters )
{
    ...
    *pxTopOfStack = ( StackType_t ) ((0x01 << 7) | (0x03 << 11));
    pxTopOfStack--;
...
BaseType_t xPortStartScheduler( void )
{
    do { CLOCK_SetIpSrc(kCLOCK_Lpit0, kCLOCK_IpSrcFircAsync); void SystemSetupSystick(uint32_t tickRateHz, uint32_t intPriority); SystemSetupSystick(((TickType_t)200), (7) - 1); } while (0);
...
void vPortEnterCritical( void )
{
    ...
    {
        if(( uxInterruptNesting == 0) == 0) {vPortSetInterruptMask(); for (;;);};
    }
}
...
{
    if(( uxCriticalNesting) == 0) {vPortSetInterruptMask(); for (;;);};
    uxCriticalNesting--;
    if( uxCriticalNesting == 0 )
    {
        vPortClearInterruptMask((7));
        if (uxYieldRequired)
        {
            __asm volatile("ecall");
        }
...
uint32_t vPortSetInterruptMask(void)
{
    ...
    ret = (*(volatile uint32_t *)(0xe0041024));

    (*(volatile uint32_t *)(0xe0041024)) = (2);
...
void vPortClearInterruptMask(uint32_t newMask)
{
    ...
    (*(volatile uint32_t *)(0xe0041024)) = newMask;
...
void LPIT0_IRQHandler( void )
{
 ...
 vPortSetInterruptMask();
    ...
    do { void SystemClearSystickFlag(void); SystemClearSystickFlag(); } while (0);
