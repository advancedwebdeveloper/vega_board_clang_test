# 1 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c" 2
# 70 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
...
# 71 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c" 2
...
# 72 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c" 2
...
# 79 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c" 2
...
# 80 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c" 2
...
# 81 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c" 2
# 130 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
...
# 161 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
...
# 182 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
...
# 208 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
...
# 247 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
...
# 279 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
BaseType_t xQueueGenericReset( QueueHandle_t xQueue, BaseType_t xNewQueue )
{
Queue_t * const pxQueue = ( Queue_t * ) xQueue;

 if(( pxQueue) == 0) {vPortSetInterruptMask(); for (;;);};
...
# 386 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
 QueueHandle_t xQueueGenericCreate( const UBaseType_t uxQueueLength, const UBaseType_t uxItemSize, const uint8_t ucQueueType )
 {
 Queue_t *pxNewQueue;
 ...
 uint8_t *pucQueueStorage;
  ...
  if(( uxQueueLength > ( UBaseType_t ) 0) == 0) {vPortSetInterruptMask(); for (;;);};
...
# 423 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
...
# 470 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
                                ;
}
...
# 572 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
 BaseType_t xQueueGiveMutexRecursive( QueueHandle_t xMutex )
 {
 BaseType_t xReturn;
 Queue_t * const pxMutex = ( Queue_t * ) xMutex;

  if(( pxMutex) == 0) {vPortSetInterruptMask(); for (;;);};
...
# 697 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
 QueueHandle_t xQueueCreateCountingSemaphore( const UBaseType_t uxMaxCount, const UBaseType_t uxInitialCount )
 {
 QueueHandle_t xHandle;

  if(( uxMaxCount != 0) == 0) {vPortSetInterruptMask(); for (;;);};
  if(( uxInitialCount <= uxMaxCount) == 0) {vPortSetInterruptMask(); for (;;);};
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if(( pxQueue) == 0) {vPortSetInterruptMask(); for (;;);};
 if(( !( ( pvItemToQueue == ((void*)0) ) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) )) == 0) {vPortSetInterruptMask(); for (;;);};
 if(( !( ( xCopyPosition == ( ( BaseType_t ) 2 ) ) && ( pxQueue->uxLength != 1 ) )) == 0) {vPortSetInterruptMask(); for (;;);};

 {
  if(( !( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) )) == 0) {vPortSetInterruptMask(); for (;;);};
 }
...
# 805 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
    {
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if(( !( ( pvItemToQueue == ((void*)0) ) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) )) == 0) {vPortSetInterruptMask(); for (;;);};
 if(( !( ( xCopyPosition == ( ( BaseType_t ) 2 ) ) && ( pxQueue->uxLength != 1 ) )) == 0) {vPortSetInterruptMask(); for (;;);};
# 945 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
                                           ;
 ...
 uxSavedInterruptStatus = vPortSetInterruptMask();
 {
  if( ( pxQueue->uxMessagesWaiting < pxQueue->uxLength ) || ( xCopyPosition == ( ( BaseType_t ) 2 ) ) )
  {
   ...
   if( cTxLock == ( ( int8_t ) -1 ) )
   {
# 1023 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
    {
     if( ( ( BaseType_t ) ( ( &( pxQueue->xTasksWaitingToReceive ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
     {
      if( xTaskRemoveFromEventList( &( pxQueue->xTasksWaitingToReceive ) ) != ( ( BaseType_t ) 0 ) )
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if(( pxQueue->uxItemSize == 0) == 0) {vPortSetInterruptMask(); for (;;);};




 if(( !( ( pxQueue->pcHead == ((void*)0) ) && ( pxQueue->pcTail != ((void*)0) ) )) == 0) {vPortSetInterruptMask(); for (;;);};
# 1109 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
                                           ;
 ...
 uxSavedInterruptStatus = vPortSetInterruptMask();
 {
  ...
  if( uxMessagesWaiting < pxQueue->uxLength )
  {
   ...
   if( cTxLock == ( ( int8_t ) -1 ) )
   {
# 1188 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
    {
     if( ( ( BaseType_t ) ( ( &( pxQueue->xTasksWaitingToReceive ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
     {
      if( xTaskRemoveFromEventList( &( pxQueue->xTasksWaitingToReceive ) ) != ( ( BaseType_t ) 0 ) )
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if(( pxQueue) == 0) {vPortSetInterruptMask(); for (;;);};
 if(( !( ( pvBuffer == ((void*)0) ) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) )) == 0) {vPortSetInterruptMask(); for (;;);};
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if(( pxQueue) == 0) {vPortSetInterruptMask(); for (;;);};
 if(( !( ( pvBuffer == ((void*)0) ) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) )) == 0) {vPortSetInterruptMask(); for (;;);};
# 1457 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
                                           ;
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if(( !( ( pvBuffer == ((void*)0) ) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) )) == 0) {vPortSetInterruptMask(); for (;;);};
 if(( pxQueue->uxItemSize != 0) == 0) {vPortSetInterruptMask(); for (;;);};
# 1550 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
                                           ;
...
UBaseType_t uxReturn;
 ...
 if(( xQueue) == 0) {vPortSetInterruptMask(); for (;;);};
...
# 1664 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
}
...
static void prvUnlockQueue( Queue_t * const pxQueue )
{
 ...
 vPortEnterCritical();
 {
  ...
  {
# 1852 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
   {
...
# 2269 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
 ...
 UBaseType_t ux;
  ...
  {
   if( xQueueRegistry[ ux ].pcQueueName == ((void*)0) )
   {
 ...
 {
 Queue_t * const pxQueue = ( Queue_t * ) xQueue;
# 2376 "C:/Vega/rv32m1_sdk_riscv/rtos/freertos_9.0.0/Source/queue.c"
  vPortEnterCritical(); { if( ( pxQueue )->cRxLock == ( ( int8_t ) -1 ) ) { ( pxQueue )->cRxLock = ( ( int8_t ) 0 ); } if( ( pxQueue )->cTxLock == ( ( int8_t ) -1 ) ) { ( pxQueue )->cTxLock = ( ( int8_t ) 0 ); } } vPortExitCritical();
