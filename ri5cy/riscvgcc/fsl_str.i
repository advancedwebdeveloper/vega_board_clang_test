# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c" 2
...
# 1 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 1 3




# 1 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\sys/reent.h" 1 3
# 13 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\sys/reent.h" 3
...
# 14 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\sys/reent.h" 2 3
...
# 6 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 2 3
...
# 7 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 2 3
# 1 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\machine/ieeefp.h" 1 3
# 8 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 2 3
...
# 109 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 3
...
# 173 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 3
    typedef float float_t;
    typedef double double_t;
# 217 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 3
...
# 313 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 3
...
# 513 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 3
extern long double hypotl (long double, long double);
extern long double sqrtl (long double);
# 526 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 3
...
# 588 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 3
extern int *__signgam (void);
# 601 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 3
struct exception
...
# 665 "C:\\Vega\\riscv32-unknown-elf-gcc\\riscv32-unknown-elf\\include\\math.h" 3
...
# 10 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c" 2
...
# 11 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c" 2
...
# 12 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c" 2
...
# 13 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/utilities/fsl_str.h"
...
# 14 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/utilities/fsl_str.h" 2
...
# 13 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c" 2
...
# 14 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c" 2
# 45 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
...
# 64 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
    kSCANF_TypeSinged = 0x2000U,
};
# 81 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
static uint32_t ScanIgnoreWhiteSpace(const char **s);
# 94 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
static int32_t ConvertRadixNumToString(char *numstr, void *nump, int32_t neg, int32_t radix, _Bool use_caps);
# 113 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
...
static int32_t ConvertRadixNumToString(char *numstr, void *nump, int32_t neg, int32_t radix, _Bool use_caps)
{
# 143 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
    int32_t a;
    int32_t b;
    int32_t c;
    ...
    *nstrp++ = '\0';
    ...
    if (neg)
    {
        ...
        while (a != 0)
        {
# 183 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
            b = a / radix;
            c = a - (b * radix);
            if (c < 0)
            {
...
# 338 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
int StrFormatPrintf(const char *fmt, va_list ap, char *buf, printfCb cb)
{
    ...
    _Bool use_caps;
    uint8_t radix = 0;
# 365 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
    int32_t ival;
    uint32_t uval = 0;
    ...
    for (p = (char *)fmt; (c = *p) != 0; p++)
    {
        ...
        use_caps = 1;
# 424 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
        field_width = 0;
        done = 0;
        while (!done)
        {
...
# 521 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
        c = *++p;
        {
                ...
                (c == 'b') || (c == 'p') || (c == 'u'))
            {
                if ((c == 'd') || (c == 'i'))
                {
                    ...
                    {
                        ival = (int32_t)__builtin_va_arg(ap, int32_t);
                    }
                    vlen = ConvertRadixNumToString(vstr, &ival, 1, 10, use_caps);
                    vstrp = &vstr[vlen];
# 597 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
                }
# 662 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
                if ((c == 'X') || (c == 'x'))
                {
                    if (c == 'x')
                    {
                    ...
                    {
                        uval = (uint32_t)__builtin_va_arg(ap, uint32_t);
                    }
                    vlen = ConvertRadixNumToString(vstr, &uval, 0, 16, use_caps);
                    vstrp = &vstr[vlen];
# 719 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
                }
                if ((c == 'o') || (c == 'b') || (c == 'p') || (c == 'u'))
                {
                    ...
                    vlen = ConvertRadixNumToString(vstr, &uval, 0, radix, use_caps);
                    vstrp = &vstr[vlen];
# 765 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
                }
            ...
            {
                cval = (char)__builtin_va_arg(ap, uint32_t);
                cb(buf, &count, cval, 1);
            }
            else if (c == 's')
            {
                ...
                if (sval)
                {
# 803 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
                    vlen = strlen(sval);
...
# 826 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
                        while (*sval)
                        {
                            cb(buf, &count, *sval++, 1);
                        }
# 840 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
                }
            }
            else
            {
    ...
    while ((*c) && (*p))
    {
        ...
        else
        {
            ...
            while ((*c) && (!(flag & kSCANF_DestMask)))
            {
                switch (*c)
                {
# 978 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
                    case '0':
                    case '1':
                    case '2':
                    case '3':
                    ...
                    case 'i':
                        ...
                        c++;
                        break;
# 1039 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
                    case 'c':
            ...
            switch (flag & kSCANF_DestMask)
            {
                ...
                case kSCANF_DestInt:
                    ...
                    if (!(flag & kSCANF_Suppress))
                    {
# 1256 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
                    ...
                    break;
# 1294 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/utilities/fsl_str.c"
                default:
                    return nassigned;
            }
        }
