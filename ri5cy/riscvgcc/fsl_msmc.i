# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_msmc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_msmc.c" 2
...
# 10 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_msmc.c" 2
# 19 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_msmc.c"
status_t SMC_SetPowerModeRun(SMC_Type *base)
{
    uint32_t reg;
...
status_t SMC_SetPowerModeWait(SMC_Type *base)
{
    ...
    ((EVENT_Type *)(0xE0041000u))->SLPCTRL = (((EVENT_Type *)(0xE0041000u))->SLPCTRL & ~0x03) | (1 << 0);
...
status_t SMC_SetPowerModeStop(SMC_Type *base, smc_partial_stop_option_t option)
{
    ...
    reg = base->PMCTRL;
    reg &= ~((0x30000U) | (0x7U));
    reg |= ((uint32_t)option << (16U)) | (kSMC_StopNormal << (0U));
    base->PMCTRL = reg;


    ((EVENT_Type *)(0xE0041000u))->SLPCTRL |= 0x03;;
    ...
    __WFI();
    __ISB();
# 87 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_msmc.c"
    return kStatus_Success;
...
status_t SMC_SetPowerModeVlps(SMC_Type *base)
{
    ...
    __WFI();
    __ISB();
# 147 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_msmc.c"
    return kStatus_Success;
...
status_t SMC_SetPowerModeLls(SMC_Type *base)
{
    ...
    __WFI();
    __ISB();
# 181 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_msmc.c"
    return kStatus_Success;
...
# 275 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_msmc.c"
void SMC_ConfigureResetPinFilter(SMC_Type *base, const smc_reset_pin_filter_config_t *config)
{
    ((config) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_msmc.c", 277, __func__, "config"));

    uint32_t reg;

    reg = (((uint32_t)(((uint32_t)(config->slowClockFilterCount)) << (0U))) & (0x1FU)) | (((uint32_t)(((uint32_t)(config->enableFilter)) << (8U))) & (0x100U));
