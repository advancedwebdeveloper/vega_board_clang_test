# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/system_RV32M1_ri5cy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/system_RV32M1_ri5cy.c" 2
# 48 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/system_RV32M1_ri5cy.c"
...
# 49 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/system_RV32M1_ri5cy.c" 2
...
# 55 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/system_RV32M1_ri5cy.h"
# 1 "C:\\Program Files\\LLVM\\lib\\clang\\11.0.0\\include\\stdbool.h" 1 3 4
# 56 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/system_RV32M1_ri5cy.h" 2
...
# 50 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/system_RV32M1_ri5cy.c" 2
...
# 51 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/system_RV32M1_ri5cy.c" 2
...
void DMA0_0_4_8_12_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void DMA0_1_5_9_13_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void DMA0_2_6_10_14_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void DMA0_3_7_11_15_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void DMA0_Error_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void CMC0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void EWM_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void FTFE_Command_Complete_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void FTFE_Read_Collision_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LLWU0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void MUA_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void SPM_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void WDOG0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void SCG_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPIT0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void RTC_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPTMR0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPTMR1_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void TPM0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void TPM1_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void TPM2_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void EMVSIM0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void FLEXIO0_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPI2C0_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPI2C1_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPI2C2_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void I2S0_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void USDHC0_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPSPI0_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPSPI1_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPSPI2_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPUART0_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPUART1_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPUART2_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void USB0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void PORTA_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void PORTB_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void PORTC_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void PORTD_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void ADC0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPCMP0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPDAC0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void CAU3_Task_Complete_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void CAU3_Security_Violation_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void TRNG_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPIT1_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPTMR2_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void TPM3_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPI2C3_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPSPI3_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPUART3_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void PORTE_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void LPCMP1_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void RF0_0_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void RF0_1_IRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void INTMUX0_0_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void INTMUX0_1_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void INTMUX0_2_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void INTMUX0_3_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void INTMUX0_4_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void INTMUX0_5_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void INTMUX0_6_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void INTMUX0_7_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));
void INTMUX0_8_DriverIRQHandler() __attribute__((weak, alias("DefaultIRQHandler")));

void __attribute__((weak)) DMA0_0_4_8_12_IRQHandler(void) { DMA0_0_4_8_12_DriverIRQHandler();};
void __attribute__((weak)) DMA0_1_5_9_13_IRQHandler(void) { DMA0_1_5_9_13_DriverIRQHandler();};
void __attribute__((weak)) DMA0_2_6_10_14_IRQHandler(void) { DMA0_2_6_10_14_DriverIRQHandler();};
void __attribute__((weak)) DMA0_3_7_11_15_IRQHandler(void) { DMA0_3_7_11_15_DriverIRQHandler();};
void __attribute__((weak)) FLEXIO0_IRQHandler(void) { FLEXIO0_DriverIRQHandler();};
void __attribute__((weak)) LPI2C0_IRQHandler(void) { LPI2C0_DriverIRQHandler();};
void __attribute__((weak)) LPI2C1_IRQHandler(void) { LPI2C1_DriverIRQHandler();};
void __attribute__((weak)) LPI2C2_IRQHandler(void) { LPI2C2_DriverIRQHandler();};
void __attribute__((weak)) I2S0_IRQHandler(void) { I2S0_DriverIRQHandler();};
void __attribute__((weak)) USDHC0_IRQHandler(void) { USDHC0_DriverIRQHandler();};
void __attribute__((weak)) LPSPI0_IRQHandler(void) { LPSPI0_DriverIRQHandler();};
void __attribute__((weak)) LPSPI1_IRQHandler(void) { LPSPI1_DriverIRQHandler();};
void __attribute__((weak)) LPSPI2_IRQHandler(void) { LPSPI2_DriverIRQHandler();};
void __attribute__((weak)) LPUART0_IRQHandler(void) { LPUART0_DriverIRQHandler();};
void __attribute__((weak)) LPUART1_IRQHandler(void) { LPUART1_DriverIRQHandler();};
void __attribute__((weak)) LPUART2_IRQHandler(void) { LPUART2_DriverIRQHandler();};
void __attribute__((weak)) LPI2C3_IRQHandler(void) { LPI2C3_DriverIRQHandler();};
void __attribute__((weak)) LPSPI3_IRQHandler(void) { LPSPI3_DriverIRQHandler();};
void __attribute__((weak)) LPUART3_IRQHandler(void) { LPUART3_DriverIRQHandler();};
void __attribute__((weak)) INTMUX0_0_IRQHandler(void) { INTMUX0_0_DriverIRQHandler();};
void __attribute__((weak)) INTMUX0_1_IRQHandler(void) { INTMUX0_1_DriverIRQHandler();};
void __attribute__((weak)) INTMUX0_2_IRQHandler(void) { INTMUX0_2_DriverIRQHandler();};
void __attribute__((weak)) INTMUX0_3_IRQHandler(void) { INTMUX0_3_DriverIRQHandler();};
void __attribute__((weak)) INTMUX0_4_IRQHandler(void) { INTMUX0_4_DriverIRQHandler();};
void __attribute__((weak)) INTMUX0_5_IRQHandler(void) { INTMUX0_5_DriverIRQHandler();};
void __attribute__((weak)) INTMUX0_6_IRQHandler(void) { INTMUX0_6_DriverIRQHandler();};
void __attribute__((weak)) INTMUX0_7_IRQHandler(void) { INTMUX0_7_DriverIRQHandler();};
...
void SystemInit (void) {
  ...
  ((WDOG_Type *)(0x4002A000u))->CNT = 0xD928C520U;
  ((WDOG_Type *)(0x4002A000u))->TOVAL = 0xFFFF;
  ((WDOG_Type *)(0x4002A000u))->CS = (uint32_t) ((((WDOG_Type *)(0x4002A000u))->CS) & ~(0x80U)) | (0x20U);
  ...
  __asm volatile("csrw 0x305, %0" :: "r"((uint32_t)__VECTOR_TABLE));
  __asm volatile("csrw 0x005, %0" :: "r"((uint32_t)__VECTOR_TABLE));


  ((EVENT_Type *)(0xE0041000u))->INTPTPENDCLEAR = 0xFFFFFFFF;
  ((EVENT_Type *)(0xE0041000u))->EVTPENDCLEAR = 0xFFFFFFFF;

  ((EVENT_Type *)(0xE0041000u))->INTPTSECURE = 0xFFFFFFFF;
}
...
void SystemCoreClockUpdate (void) {
  ...
  uint32_t SCGOUTClock;
  uint16_t Divider;
  Divider = ((((SCG_Type *)(0x4002C000u))->CSR & (0xF0000U)) >> (16U)) + 1;

  switch ((((SCG_Type *)(0x4002C000u))->CSR & (0xF000000U)) >> (24U)) {
    case 0x1:
    ...
    case 0x2:
      ...
      SCGOUTClock = (((((SCG_Type *)(0x4002C000u))->SIRCCFG & (0x1U)) >> (0U)) ? 8000000 : 2000000);
      break;
    case 0x3:

      SCGOUTClock = 48000000 + ((((SCG_Type *)(0x4002C000u))->FIRCCFG & (0x3U)) >> (0U)) * 4000000;
      break;
    case 0x5:

      SCGOUTClock = 48000000 + ((((SCG_Type *)(0x4002C000u))->LPFLLCFG & (0x3U)) >> (0U)) * 24000000;
      break;
    default:
      return;
  }
...
__attribute__((weak)) void SystemIrqHandler(uint32_t mcause) {
    ...
    if (mcause & 0x80000000)
    {
        ...
        ((EVENT_Type *)(0xE0041000u))->INTPTPENDCLEAR = (1U << intNum);


        (void)(((EVENT_Type *)(0xE0041000u))->INTPTPENDCLEAR);
...
void SystemSetupSystick(uint32_t tickRateHz, uint32_t intPriority)
{
    ...
    ((LPIT_Type *)(0x40030000u))->MCR |= (0x2U);
    ((LPIT_Type *)(0x40030000u))->MCR &= ~(0x2U);


    ((LPIT_Type *)(0x40030000u))->MCR = (0x8U) | (0x4U) | (0x1U);


    ((LPIT_Type *)(0x40030000u))->CHANNEL[0].TVAL = (CLOCK_GetIpFreq(kCLOCK_Lpit0) / tickRateHz) - 1;


    ((LPIT_Type *)(0x40030000u))->MIER |= (1U << 0);


    EVENT_SetIRQPriority(LPIT0_IRQn, intPriority);


    EnableIRQ(LPIT0_IRQn);


    ((LPIT_Type *)(0x40030000u))->SETTEN |= ((0x1U) << 0);
}
...
void SystemClearSystickFlag(void)
{
    ...
    ((LPIT_Type *)(0x40030000u))->MSR = (1U << 0);
}
...
void EVENT_SetIRQPriority(IRQn_Type IRQn, uint8_t intPriority)
{
    ...
    if ((IRQn < 32) && (intPriority < 8))
    {
        ...
        ((EVENT_Type *)(0xE0041000u))->INTPTPRI[regIdx] = (((EVENT_Type *)(0xE0041000u))->INTPTPRI[regIdx] & ~(0x0F << regOffset)) | (intPriority << regOffset);
    }
}
...
uint8_t EVENT_GetIRQPriority(IRQn_Type IRQn)
{
    ...
    if ((IRQn < 32))
    {
        ...
        intPriority = (((EVENT_Type *)(0xE0041000u))->INTPTPRI[regIdx] >> regOffset) & 0xF;
...
_Bool SystemInISR(void)
{
    return ((((EVENT_Type *)(0xE0041000u))->INTPTENACTIVE) != 0);;
}

void EVENT_SystemReset(void)
{
    ((EVENT_Type *)(0xE0041000u))->SLPCTRL |= (0x80000000U);
}
