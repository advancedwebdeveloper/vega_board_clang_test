# 1 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/pin_mux.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/pin_mux.c" 2
# 19 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/pin_mux.c"
...
# 20 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/pin_mux.c" 2
# 1 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h" 1
# 30 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h"
enum _port_pull
{
...
typedef struct _port_pin_config
{
    ...
    uint16_t mux : 3;
    uint16_t : 4;
# 196 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h"
    uint16_t lockRegister : 1;



} port_pin_config_t;
# 236 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h"
static inline void PORT_SetPinConfig(PORT_Type *base, uint32_t pin, const port_pin_config_t *config)
{
    ((config) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h", 238, __func__, "config"));
    uint32_t addr = (uint32_t)&base->PCR[pin];
    *(volatile uint16_t *)(addr) = *((const uint16_t *)config);
}
# 265 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h"
static inline void PORT_SetMultiplePinsConfig(PORT_Type *base, uint32_t mask, const port_pin_config_t *config)
{
    ((config) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h", 267, __func__, "config"));
...
# 303 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h"
static inline void PORT_SetMultipleInterruptPinsConfig(PORT_Type *base, uint32_t mask, port_interrupt_t config)
{
    ((config) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h", 305, __func__, "config"));
...
# 338 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h"
static inline void PORT_SetPinMux(PORT_Type *base, uint32_t pin, port_mux_t mux)
{
    base->PCR[pin] = (base->PCR[pin] & ~(0x700U)) | (((uint32_t)(((uint32_t)(mux)) << (8U))) & (0x700U));
}
# 352 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h"
static inline void PORT_EnablePinsDigitalFilter(PORT_Type *base, uint32_t mask, _Bool enable)
{
    if (enable == 1)
    {
        base->DFER |= mask;
...
{
    ((config) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h", 372, __func__, "config"));

    base->DFCR = (((uint32_t)(((uint32_t)(config->clockSource)) << (0U))) & (0x1U));
    base->DFWR = (((uint32_t)(((uint32_t)(config->digitalFilterWidth)) << (0U))) & (0x1FU));
}
# 406 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h"
static inline void PORT_SetPinInterruptConfig(PORT_Type *base, uint32_t pin, port_interrupt_t config)
{
    base->PCR[pin] = (base->PCR[pin] & ~(0xF0000U)) | (((uint32_t)(((uint32_t)(config)) << (16U))) & (0xF0000U));
}
# 421 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h"
static inline void PORT_SetPinDriveStrength(PORT_Type* base, uint32_t pin, uint8_t strength)
{
    base->PCR[pin] = (base->PCR[pin] & ~(0x40U)) | (((uint32_t)(((uint32_t)(strength)) << (6U))) & (0x40U));
}
# 440 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers\\fsl_port.h"
...
# 21 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/pin_mux.c" 2
...
# 22 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/pin_mux.c" 2
...
# 52 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/pin_mux.c"
void BOARD_InitPins(void) {
  CLOCK_EnableClock(kCLOCK_PortC);

  PORT_SetPinMux(((PORT_Type *)(0x40048000u)), 7u, kPORT_MuxAlt3);
  PORT_SetPinMux(((PORT_Type *)(0x40048000u)), 8u, kPORT_MuxAlt3);
}
