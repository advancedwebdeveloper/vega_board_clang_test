# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_gpio.c" 2
...
# 12 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers/fsl_gpio.h"
...
# 13 "C:/Vega/rv32m1_sdk_riscv/boards/rv32m1_vega/rtos_examples/freertos_hello/ri5cy/riscvgcc/../../../../../../devices/RV32M1/drivers/fsl_gpio.h" 2
...
# 10 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_gpio.c" 2




static PORT_Type *const s_portBases[] = { ((PORT_Type *)(0x40046000u)), ((PORT_Type *)(0x40047000u)), ((PORT_Type *)(0x40048000u)), ((PORT_Type *)(0x40049000u)), ((PORT_Type *)(0x41037000u)) };
static GPIO_Type *const s_gpioBases[] = { ((GPIO_Type *)(0x48020000u)), ((GPIO_Type *)(0x48020040u)), ((GPIO_Type *)(0x48020080u)), ((GPIO_Type *)(0x480200C0u)), ((GPIO_Type *)(0x4100F000u)) };
# 40 "C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_gpio.c"
...
static uint32_t GPIO_GetInstance(GPIO_Type *base)
{
    ...
    ((instance < (sizeof(s_gpioBases) / sizeof((s_gpioBases)[0]))) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_gpio.c", 59, __func__, "instance < ARRAY_SIZE(s_gpioBases)"));
...
void GPIO_PinInit(GPIO_Type *base, uint32_t pin, const gpio_pin_config_t *config)
{
    ((config) ? (void)0 : __assert_func ("C:/Vega/rv32m1_sdk_riscv/devices/RV32M1/drivers/fsl_gpio.c", 66, __func__, "config"));
